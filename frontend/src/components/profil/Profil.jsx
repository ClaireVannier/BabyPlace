...
function Profile() {
  ...
  return (
    <div className="profilContainer">
      <h2 className="myreservations">Mes Réservations</h2>
      <h3 className="profilTitle">{`Bonjour ${parentData.firstName} ${parentData.lastName} 😁 `}</h3>
